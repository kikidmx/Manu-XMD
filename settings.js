...
SESSION_ID: process.env.SESSION_ID === undefined ? 'Manu-MD&RGVWgaLS#J8bLbtMoYewwZ04Xhn22M-4V91lbJsCvX7I8IHwjnm8' : process.env.SESSION_ID,
PREFIX: process.env.PREFIX || '.' ,
PORT: process.env.PORT === undefined ? "8000" : process.env.PORT,
SUDO: process.env.SUDO === undefined ? '0721534466' : process.env.SUDO,
